...
import { useState, useEffect, forwardRef, useRef, useImperativeHandle, useMemo, useCallback, Fragment, createElement, Component } from "react";
...
function VisionContainer(props) {
  const $ = c(15), loadedDatasets = useDatasets(props.client);
  if (!loadedDatasets) {
    let t02;
  ...
  let t3;
  return $[10] !== datasets || $[11] !== defaultDataset || $[12] !== projectId || $[13] !== props ? (t3 = /* @__PURE__ */ createElement(VisionGui, { ...props, key: projectId, datasets, projectId, defaultDataset }), $[10] = datasets, $[11] = defaultDataset, $[12] = projectId, $[13] = props, $[14] = t3) : t3 = $[14], t3;
}
