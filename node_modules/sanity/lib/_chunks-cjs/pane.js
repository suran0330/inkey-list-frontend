    ...
    $[43] !== documentTitle ? (t162 = {
      ...
      /* @__PURE__ */ jsxRuntime.jsxs(ui.Box, { overflow: "auto", paddingTop: 2, children: [
        /* @__PURE__ */ jsxRuntime.jsxs(Table$1, { children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsx("tbody", { children: crossDatasetReferences.references.filter(_temp$r).map((t172, index) => {
            const {
              projectId,
              datasetName,
              documentId
...
function useReferringDocuments(documentId) {
  ...
  let t5;
  $[8] !== crossDatasetReferences?.references ? (t5 = () => Array.from(new Set(crossDatasetReferences?.references.map(_temp$q).filter(Boolean))).sort(), $[8] = crossDatasetReferences?.references, $[9] = t5) : t5 = $[9];
  let t6;
...
function PaneLayout(props) {
  ...
  const [controller] = React.useState(_temp$p), [rootElement, setRootElement] = React.useState(null), width = ui.useElementRect(rootElement)?.width || 0, collapsed = width === void 0 || !minWidth ? void 0 : width < minWidth;
  let t0;
...
function PaneHeaderCreateButton(t0) {
  ...
  let t3;
  t3 = !isTemplatePermissionsLoading && templatePermissions?.every(_temp$o);
...
function MissingSchemaType(props) {
  ...
  let t6;
  return $[12] !== layout || $[13] !== t2 || $[14] !== t5 ? (t6 = /* @__PURE__ */ jsxRuntime.jsx(sanity.SanityDefaultPreview, { title: t2, subtitle: t5, media: _temp$n, layout }), $[12] = layout, $[13] = t2, $[14] = t5, $[15] = t6) : t6 = $[15], t6;
}
function _temp$n() {
...
function usePathSyncChannel(t0) {
  ...
  if ($[3] !== id || $[4] !== syncChannel) {
    ...
    $[6] !== id ? (t42 = (t5) => {
      ...
      return source !== id;
    }, $[6] = id, $[7] = t42) : t42 = $[7], t3 = syncChannel.pipe(rxjs.distinctUntilChanged(_temp$k), rxjs.filter(t42), rxjs.map(_temp2$7)), $[3] = id, $[4] = syncChannel, $[5] = t3;
  } else
    t3 = $[5];
  t2 = t3;
  const path = t2;
...
`, DiffViewPane = React.forwardRef(function(t0, ref) {
  ...
  const compareValue = useCompareValue(t1), [patchChannel] = React.useState(_temp$j);
  let t2;
...
const FavoriteToggle = (t0) => {
  ...
  bb1: {
    ...
    $[55] === Symbol.for("react.memo_cache_sentinel") ? (t17 = /* @__PURE__ */ jsxRuntime.jsx(RevisionNotFoundBanner, {}), t18 = /* @__PURE__ */ jsxRuntime.jsx(ReferenceChangedBanner, {}), t19 = /* @__PURE__ */ jsxRuntime.jsx(DeprecatedDocumentTypeBanner, {}), t20 = /* @__PURE__ */ jsxRuntime.jsx(CanvasLinkedBanner, {}), t21 = /* @__PURE__ */ jsxRuntime.jsx(DeletedDocumentBanners, {}), t22 = /* @__PURE__ */ jsxRuntime.jsx(UnpublishedDocumentBanner, {}), $[55] = t17, $[56] = t18, $[57] = t19, $[58] = t20, $[59] = t21, $[60] = t22) : (t17 = $[55], t18 = $[56], t19 = $[57], t20 = $[58], t21 = $[59], t22 = $[60]);
    const t23 = displayed?._id ?? documentId;
    let t24;
    $[61] !== isPinnedDraftOrPublish || $[62] !== t23 ? (t24 = /* @__PURE__ */ jsxRuntime.jsx(OpenReleaseToEditBanner, { documentId: t23, isPinnedDraftOrPublished: isPinnedDraftOrPublish }), $[61] = isPinnedDraftOrPublish, $[62] = t23, $[63] = t24) : t24 = $[63];
    let t25;
    $[64] !== t152 || $[65] !== t16 || $[66] !== t24 ? (t25 = /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
      t152,
      t16,
      t17,
      t18,
  ...
  let t13;
  $[68] !== activeViewNode || $[69] !== banners || $[70] !== documentScrollElement || $[71] !== footer || $[72] !== formViewHidden || $[73] !== inspectDialog || $[74] !== layoutCollapsed || $[75] !== margins || $[76] !== portalElement || $[77] !== showFormView ? (t13 = showFormView && /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { height: "fill", direction: "column", width: "fill", flex: 2, children: [
  ...
  let t14;
  $[79] !== documentId || $[80] !== rootElement || $[81] !== schemaType || $[82] !== showInspector ? (t14 = showInspector && /* @__PURE__ */ jsxRuntime.jsx(ui.BoundaryElementProvider, { element: rootElement, children: /* @__PURE__ */ jsxRuntime.jsx(DocumentInspectorPanel, { documentId, documentType: schemaType.name, flex: 1 }) }), $[79] = documentId, $[80] = rootElement, $[81] = schemaType, $[82] = showInspector, $[83] = t14) : t14 = $[83];
  let t15;
  return $[84] !== t13 || $[85] !== t14 ? (t15 = /* @__PURE__ */ jsxRuntime.jsx(PaneContent, { children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { height: "fill", children: [
    t13,
    t14
