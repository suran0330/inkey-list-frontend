...
function PresentationDocumentHeader(props) {
  ...
  if ($[5] !== contextOptions || $[6] !== documentId || $[7] !== resolvers || $[8] !== schemaType || $[9] !== version) {
    ...
    t2 = $[10];
  let t3;
  return $[17] !== t2 ? (t3 = /* @__PURE__ */ jsxRuntime.jsx(LocationStack, { marginBottom: 5, space: 5, children: /* @__PURE__ */ jsxRuntime.jsx(ui.Stack, { space: 2, children: t2 }) }), $[17] = t2, $[18] = t3) : t3 = $[18], t3;
}
function _temp$1(o) {
