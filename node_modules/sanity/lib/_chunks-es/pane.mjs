    ...
    $[43] !== documentTitle ? (t162 = {
      ...
      /* @__PURE__ */ jsxs(Box, { overflow: "auto", paddingTop: 2, children: [
        /* @__PURE__ */ jsxs(Table$1, { children: [
          ...
          /* @__PURE__ */ jsx("tbody", { children: crossDatasetReferences.references.filter(_temp$r).map((t172, index) => {
            const {
              projectId,
              datasetName,
              documentId
...
function PaneLayout(props) {
  ...
  const [controller] = useState(_temp$p), [rootElement, setRootElement] = useState(null), width = useElementRect(rootElement)?.width || 0, collapsed = width === void 0 || !minWidth ? void 0 : width < minWidth;
  let t0;
...
function MissingSchemaType(props) {
  ...
  let t6;
  return $[12] !== layout || $[13] !== t2 || $[14] !== t5 ? (t6 = /* @__PURE__ */ jsx(SanityDefaultPreview, { title: t2, subtitle: t5, media: _temp$n, layout }), $[12] = layout, $[13] = t2, $[14] = t5, $[15] = t6) : t6 = $[15], t6;
}
function _temp$n() {
...
function usePathSyncChannel(t0) {
  ...
  if ($[3] !== id || $[4] !== syncChannel) {
    ...
    $[6] !== id ? (t42 = (t5) => {
      ...
      return source !== id;
    }, $[6] = id, $[7] = t42) : t42 = $[7], t3 = syncChannel.pipe(distinctUntilChanged$1(_temp$k), filter(t42), map$1(_temp2$7)), $[3] = id, $[4] = syncChannel, $[5] = t3;
  } else
    t3 = $[5];
  t2 = t3;
  const path = t2;
...
`, DiffViewPane = forwardRef(function(t0, ref) {
  ...
  const compareValue = useCompareValue(t1), [patchChannel] = useState(_temp$j);
  let t2;
...
const FavoriteToggle = (t0) => {
  ...
  bb1: {
    ...
    $[55] === Symbol.for("react.memo_cache_sentinel") ? (t17 = /* @__PURE__ */ jsx(RevisionNotFoundBanner, {}), t18 = /* @__PURE__ */ jsx(ReferenceChangedBanner, {}), t19 = /* @__PURE__ */ jsx(DeprecatedDocumentTypeBanner, {}), t20 = /* @__PURE__ */ jsx(CanvasLinkedBanner, {}), t21 = /* @__PURE__ */ jsx(DeletedDocumentBanners, {}), t22 = /* @__PURE__ */ jsx(UnpublishedDocumentBanner, {}), $[55] = t17, $[56] = t18, $[57] = t19, $[58] = t20, $[59] = t21, $[60] = t22) : (t17 = $[55], t18 = $[56], t19 = $[57], t20 = $[58], t21 = $[59], t22 = $[60]);
    const t23 = displayed?._id ?? documentId;
    let t24;
    $[61] !== isPinnedDraftOrPublish || $[62] !== t23 ? (t24 = /* @__PURE__ */ jsx(OpenReleaseToEditBanner, { documentId: t23, isPinnedDraftOrPublished: isPinnedDraftOrPublish }), $[61] = isPinnedDraftOrPublish, $[62] = t23, $[63] = t24) : t24 = $[63];
    let t25;
    $[64] !== t152 || $[65] !== t16 || $[66] !== t24 ? (t25 = /* @__PURE__ */ jsxs(Fragment, { children: [
      t152,
      t16,
      t17,
      t18,
  ...
  let t13;
  $[68] !== activeViewNode || $[69] !== banners || $[70] !== documentScrollElement || $[71] !== footer || $[72] !== formViewHidden || $[73] !== inspectDialog || $[74] !== layoutCollapsed || $[75] !== margins || $[76] !== portalElement || $[77] !== showFormView ? (t13 = showFormView && /* @__PURE__ */ jsxs(Flex, { height: "fill", direction: "column", width: "fill", flex: 2, children: [
  ...
  let t14;
  $[79] !== documentId || $[80] !== rootElement || $[81] !== schemaType || $[82] !== showInspector ? (t14 = showInspector && /* @__PURE__ */ jsx(BoundaryElementProvider, { element: rootElement, children: /* @__PURE__ */ jsx(DocumentInspectorPanel, { documentId, documentType: schemaType.name, flex: 1 }) }), $[79] = documentId, $[80] = rootElement, $[81] = schemaType, $[82] = showInspector, $[83] = t14) : t14 = $[83];
  let t15;
  return $[84] !== t13 || $[85] !== t14 ? (t15 = /* @__PURE__ */ jsx(PaneContent, { children: /* @__PURE__ */ jsxs(Flex, { height: "fill", children: [
    t13,
    t14
